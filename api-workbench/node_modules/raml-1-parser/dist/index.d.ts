 ...
 **/
export declare function loadRAMLSync(ramlPath: string, extensionsAndOverlays: string[], options?: parserCore.Options): api10.RAMLLanguageElement | api08.RAMLLanguageElement;
/**
 ...
 **/
export declare function loadRAML(ramlPath: string, extensionsAndOverlays: string[], options?: parserCore.Options): Promise<api10.RAMLLanguageElement | api08.RAMLLanguageElement>;
/**
